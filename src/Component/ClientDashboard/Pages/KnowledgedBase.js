                ...
                <div className='row'>
                    ...
                    <div class=" col-xl-4 col-lg-4 col-sm-12 col-xs-6 ">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <Link to="/ClientDashboard/KnowledgedBase/faqs">FAQ
                    ...
                    <div class="col-sm-4 col-xl-4 col-lg-4 col-sm-12 col-xs-6 ">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <Link to="/ClientDashboard/KnowledgedBase/Articles">Articles
                                    <RightOutlined className='RightOutlined' />
                    ...
                    <div class="col-sm-4 col-xl-4 col-lg-4 col-sm-12 col-xs-6 ">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <Link to="/ClientDashboard/KnowledgedBase/tutorials">Tutorials
                                    <RightOutlined className='RightOutlined' />
